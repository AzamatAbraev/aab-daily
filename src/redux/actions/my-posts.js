...
const updateStateChange = (payload) => ({ type: MYPOST_ACTIONS, payload });
...
export const sendMyPosts =
  ...
  async (dispatch) => {
    try {
      ...
      dispatch(getMyPosts(activePage, search));
      form.resetFields();
    } catch (err) {
